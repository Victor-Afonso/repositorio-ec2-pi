...
//        this.datasource.setUrl("jdbc:h2:file:./meu_banco");
        ...
        this.datasource.setUrl("jdbc:sqlserver://svr-monitech.database.windows.net:1433;database=bd-Monitech;user=admin-Monitech@svr-monitech;password={your_password_here};encrypt=true;trustServerCertificate=false;hostNameInCertificate=*.database.windows.net;loginTimeout=30;");
